...
//шахматы
        ...
        System.out.println("Введите фигуру");//Производим ввод параметров для работы
        ...
        //Задача 3
        //чтобы набор букв встречался в слове в такой же последовательности в которой он есть
        //butl beautiful
        int j = 0;
        int counter1 = 0;
        ...
        //Задача 4
//произведение цифр массива пока не будет однозначным
        int num = 0;
        int nextNum = 1;
        ...
        //Задача 5
//те же гласные что и в первом слове toe ocelot maniac
        char[] vowels={'a', 'e', 'i', 'o', 'q', 'u', 'y'};
        int counter2 = 0;
...
//цифра в слова
        ...
        String[] ruDoublDigit = {"десять","одиннадцать","двенадцать","тринадцать","четырнадцать","пятнадцать","шестнадцать","семнадцать","восемнадцать","девятьнадцать"};
        ...
        int num1 = sc7.nextInt(); //Вводим число
        ...
        //Задача 9
// меняет регистр слов sansa stark, lady of winterfell.
        ...
        System.out.println("Ведите число для построения шестиугольника");
