...
public class b6 {
    ...
    public static void main(String[] args) {
        ...
        //удаляет дублирующиеся параметры запроса и параметры, указанные во втором аргументе
        ...
        //Задача 5
        //How the Avocado Became the Fruit of the Global Trade хэштеги
        System.out.println("Задача 5");
        System.out.println("Введите заголовок газеты");
        Scanner sc5 = new Scanner(System.in);
        str = sc5.nextLine(); //Вводим предложение
        ...
        //Задача 7
        // самую длинную неповторяющуюся подстроку abcabcbb
        ...
        //Задача 9
        //является ли формула правильной или нет 6 * 4 = 24
        ...
        //Задача 10
        //палиндром и его потомки 11211230
