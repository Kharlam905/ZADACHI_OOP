...
public class b3 {
    public static void main(String[] args) {
        ...
        System.out.println("   findZip('fggghvfgcddt'): "+findZip("fggghvfgcddt"));
        System.out.println("   findZip('zip abc zip zip'): "+findZip("zip abc zip zip"));
        System.out.println();

        System.out.println("3) checkPerfect(6): "+checkPerfect(6));
        System.out.println("   checkPerfect(28): "+checkPerfect(28));
        System.out.println("   checkPerfect(29): "+checkPerfect(29));
        System.out.println();

        System.out.println("4) flipEndChars('abcdefg'): "+flipEndChars("abcdefg"));
        ...
        System.out.println("   isValidHexCode('#f5f4ac'): "+isValidHexCode("#fffaac"));
        System.out.println("   isValidHexCode('#cde1s'): "+isValidHexCode("#cdefs"));
        System.out.println();
        ...
        System.out.println("   isKaprekar(2): "+isKaprekar(5));
        System.out.println("   isKaprekar(289): "+isKaprekar(297));
        System.out.println();
...
//2
    //найти второе вхождение zip в строку
...
//10
    //является ли прямоуголным треугольником
